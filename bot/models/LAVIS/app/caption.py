...
def app():
    ...
    sampling_method = st.sidebar.selectbox("Sampling method:", ["Beam search", "Nucleus sampling"])
    ...
    if cap_button:
        ...
        captions = generate_caption(model=model, image=img, use_nucleus_sampling=not use_beam)
