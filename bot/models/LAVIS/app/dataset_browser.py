            ...
            for col in st.columns(num_cols):
                ...
                try:
                    ...
                    if visual_key == "image":
                        ...
                        col.markdown("![Alt Text](https://media.giphy.com/media/vFKqnCdLPNOKc/giphy.gif)")
...
if __name__ == "__main__":
    ...
    if function == "Browser":
        ...
        elif st.session_state.last_dataset != dataset_name or st.session_state.last_split != split:
            st.session_state.first_run = True
