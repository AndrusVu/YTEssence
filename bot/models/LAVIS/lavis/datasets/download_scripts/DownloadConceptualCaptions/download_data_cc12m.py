...
def open_tsv(fname, folder):
    ...
    df = pd.read_csv(fname, sep="\t", names=["url", "caption"])  # , usecols=range(1, 2))
    df["folder"] = folder
...
storage_dir = OmegaConf.load(config_path).datasets.conceptual_caption_12m.build_info.images.storage
